    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        composeBottomNav.setContent {
            CustomBottomNavigationBar(
                items = listOf(
                    BottomNavItem("Home", R.drawable.ic_homebotnav, R.id.navigation_home),
                    BottomNavItem("Rangking", R.drawable.ic_rangkingbotnav, R.id.navigation_rangking),
                    BottomNavItem("Treasure", R.drawable.ic_shopbotnav, R.id.navigation_shop)
                ),
                onItemClick = { item ->
